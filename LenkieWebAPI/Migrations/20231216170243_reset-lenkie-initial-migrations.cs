...
{
    /// <inheritdoc />
    public partial class resetlenkieinitialmigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BookReservationTracking",
                columns: table => new
                {
                    BookResevervationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookReservationTracking", x => x.BookResevervationId);
                    table.ForeignKey(
                        name: "FK_BookReservationTracking_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookReservationTracking_Customers_Email",
                        column: x => x.Email,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowedBooks_Customers_Email",
                        column: x => x.Email,
                        principalTable: "Customers",
                        principalColumn: "CustomerId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookReservationTracking_BookId",
                table: "BookReservationTracking",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookReservationTracking_Email",
                table: "BookReservationTracking",
                column: "Email");
